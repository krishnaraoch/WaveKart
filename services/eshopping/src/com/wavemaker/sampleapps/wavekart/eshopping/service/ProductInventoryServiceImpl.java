...
public class ProductInventoryServiceImpl implements ProductInventoryService {
    ...
    public ProductInventory delete(Integer productinventoryId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), ProductInventory.class.getSimpleName(), productinventoryId);
        }
