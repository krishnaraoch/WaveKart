...
public class EshoppingQueryExecutorServiceImpl implements EshoppingQueryExecutorService {
    ...
    public void exportTotalItemsPrice_CartProd(Integer cartId, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<TotalItemsPriceCartProdResponse> queryInput = new QueryProcedureInput<>("TotalItemsPrice_CartProd", params, TotalItemsPriceCartProdResponse.class);
    ...
    public void exportTotalItemsPrice_Orders(Integer oid, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<TotalItemsPriceOrdersResponse> queryInput = new QueryProcedureInput<>("TotalItemsPrice_Orders", params, TotalItemsPriceOrdersResponse.class);
    ...
    public void exportGet_CartIdByUserid(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<GetCartIdByUseridResponse> queryInput = new QueryProcedureInput<>("Get_CartIdByUserid", params, GetCartIdByUseridResponse.class);
    ...
    public void exportMyCart_Items_Count(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<MyCartItemsCountResponse> queryInput = new QueryProcedureInput<>("MyCart_Items_Count", params, MyCartItemsCountResponse.class);
    ...
    public void exportQV_getInventoryDetails(List<Integer> productIds, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<QvGetInventoryDetailsResponse> queryInput = new QueryProcedureInput<>("QV_getInventoryDetails", params, QvGetInventoryDetailsResponse.class);
    ...
    public void exportGet_CartItems_id(Integer cid, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        ...
        QueryProcedureInput<GetCartItemsIdResponse> queryInput = new QueryProcedureInput<>("Get_CartItems_id", params, GetCartItemsIdResponse.class);
