...
/**
 * Specifies methods used to obtain and modify CartDetails related information
 * which is stored in the database.
 */
@Repository("eshopping.CartDetailsDao")
public class CartDetailsDao extends WMGenericDaoImpl<CartDetails, Integer> {
