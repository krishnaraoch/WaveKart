...
/**
 * Specifies methods used to obtain and modify UserAddressDetails related information
 * which is stored in the database.
 */
@Repository("eshopping.UserAddressDetailsDao")
public class UserAddressDetailsDao extends WMGenericDaoImpl<UserAddressDetails, Integer> {
    ...
    @Autowired
    @Qualifier("eshoppingWMQLTypeHelper")
