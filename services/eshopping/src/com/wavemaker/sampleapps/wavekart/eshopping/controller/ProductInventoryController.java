...
public class ProductInventoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ProductInventory getProductInventory(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ProductInventory editProductInventory(@PathVariable("id") Integer id, @RequestBody ProductInventory productInventory) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteProductInventory(@PathVariable("id") Integer id) {
    ...
    public Page<ProductInventory> searchProductInventoriesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering ProductInventories list by query filter:{}", (Object) queryFilters);
    ...
    public Page<ProductInventory> findProductInventories(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering ProductInventories list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportProductInventoriesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = ProductInventory.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> productInventoryService.export(exportOptions, pageable, outputStream));
