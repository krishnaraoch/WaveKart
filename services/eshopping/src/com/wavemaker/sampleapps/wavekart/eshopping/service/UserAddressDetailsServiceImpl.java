...
public class UserAddressDetailsServiceImpl implements UserAddressDetailsService {
    ...
    public UserAddressDetails delete(Integer useraddressdetailsId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), UserAddressDetails.class.getSimpleName(), useraddressdetailsId);
        }
