...
Page.SV_getInventoryDetailsonSuccess = function(variable, data, options) {
  var requiredQuantities = _.map(Page.Variables.LV_CartItemsData.dataSet, 'productQuantity'), quantities = _.map(options.rawData, 'quantity'), validOrder = _.every(quantities, function(item, index) {
